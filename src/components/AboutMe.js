...
function AboutMe() {
  ...
  return (
    <div className="aboutcontainer">
      ...
      <p>
        I utilized my skills as a self-taught musician and graphic designer to
        teach myself how to code.
      </p>
      <p>
        To further grow as a developer, I attended
      ...
      <p>
        Now, my ambition as a developer is to be a part of something meaningful,
      ...
      <div
        ...
        <img src={over ? katCool : kat} alt={"insert cool pic of kat here"} />
      </div>
    </div>
  );
}
